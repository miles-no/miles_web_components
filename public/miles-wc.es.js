...
var de = (s, e, i) => e in s ? le(s, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : s[e] = i;
var a = (s, e, i) => (de(s, typeof e != "symbol" ? e + "" : e, i), i);
...
const g = "miles-cloud";
customElements.get(g) || customElements.define(g, ce);
...
const u = "miles-heart";
customElements.get(u) || customElements.define(u, he);
...
const v = "miles-bulb";
customElements.get(v) || customElements.define(v, pe);
...
const b = "miles-cup";
customElements.get(b) || customElements.define(b, ge);
...
const w = "miles-zoom";
customElements.get(w) || customElements.define(w, ue);
...
const y = "miles-pod";
customElements.get(y) || customElements.define(y, fe);
const ve = `:host{display:inline-block;width:inherit;box-sizing:border-box}
...
const x = "miles-logo";
customElements.get(x) || customElements.define(x, be);
const k = (s) => [null, "false"].includes(s) === !1, X = document.createElement("template");
X.innerHTML = `
        <style>
          ${r}
...
class we extends HTMLElement {
  constructor() {
    super();
    const e = this.attachShadow({ mode: "open" });
    e.append(X.content.cloneNode(!0)), this.buttontarget = e.querySelector("#buttonTarget");
  }
  static get observedAttributes() {
...
class xe extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }).append(W.content.cloneNode(!0)), this.officeLocation = this.shadowRoot.querySelector("#location"), this.jobTitle = this.shadowRoot.querySelector("#jobtitle"), this.consultantName = this.shadowRoot.querySelector("#name"), this.profileImage = this.shadowRoot.querySelector("#profileimage");
  }
  static get observedAttributes() {
...
class _e extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }).appendChild(G.content.cloneNode(!0)), this.titlEl = this.shadowRoot.querySelector("#title"), this.dateEl = this.shadowRoot.querySelector("#date");
  }
  static get observedAttributes() {
...
customElements.get(M) || customElements.define(M, _e);
const Me = `:host{display:inline-block;color:red;--arrow-bg-color: #ffffff;--arrow-color: #b72a26}#arrow-nav{display:flex;padding:.8rem;border-radius:50%;background-color:#94e5db}svg{display:inline-block}
...
class Se extends HTMLElement {
  constructor() {
    super();
    const e = this.attachShadow({ mode: "open" });
    e.appendChild(J.content.cloneNode(!0)), this.nav = e.querySelector("#arrow-nav");
  }
  static get observedAttributes() {
    return ["width", "height", "color"];
  }
...
class Ae extends HTMLElement {
  constructor() {
    ...
    i.appendChild(K.content.cloneNode(!0)), this.slides = i.querySelector(".slides"), this.controls = i.querySelector(".controls"), this.wrapper = i.querySelector("#slide-wrapper"), this.numberOfSlides = 0, this.autoPlay = 0, this.index = 0, this.logos = ["equinor", "fjordkraft", "tv2", "cutters", "scaleaq"], this.rightNav = i.querySelector("#rightnav"), this.leftNav = i.querySelector("#leftnav");
  }
  connectedCallback() {
    let i = {
      root: null,
...
class He extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.append(Q.content.cloneNode(!0));
  }
  connectedCallback() {
...
class Re extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.append(Y.content.cloneNode(!0)), this.list = this.shadowRoot.querySelector("#list");
  }
  connectedCallback() {
    const e = [
      "Systemutvikling",
...
class Pe extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.append(ee.content.cloneNode(!0)), this.banner = this.shadowRoot.querySelector("#banner"), this.menu = this.shadowRoot.querySelector("#menu"), this.people = this.shadowRoot.querySelector("#people"), this.triggerEl = this.shadowRoot.querySelector("#triggerEl"), this.header = null;
  }
  connectedCallback() {
    const i = this.shadowRoot.querySelector("slot").assignedElements()[0];
...
const q = "miles-office-banner";
customElements.get(q) || customElements.define(q, Pe);
const Be = `:host{display:inline-block;transform:rotate(180deg);transition:transform .5s cubic-bezier(.46,.03,.52,.96)}#arrow{justify-content:center;display:flex;width:inherit;height:inherit;align-items:center}:host(.open){transform:rotate(0)}svg{width:inherit;height:inherit}
...
class oe extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.append(ie.content.cloneNode(!0)), this.emailEl = this.shadowRoot.querySelector("#email"), this.nameEl = this.shadowRoot.querySelector("#name"), this.phoneEl = this.shadowRoot.querySelector("#phone"), this.titleEl = this.shadowRoot.querySelector("#title"), this.firgureEl = this.shadowRoot.querySelector("figure"), this.card = this.shadowRoot.querySelector("#card");
  }
  static get observedAttributes() {
...
customElements.get(z) || customElements.define(z, oe);
class Fe extends oe {
  constructor() {
    super();
  }
...
class Oe extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.append(se.content.cloneNode(!0)), this.headingEl = this.shadowRoot.querySelector("h2");
  }
  static get observedAttributes() {
    return ["heading"];
  }
...
const De = `:host{display:inline-block;color:inherit}#wrapper{background-color:var(--miles_secondary_four);display:flex;flex-direction:column}h2{margin:0}a{text-decoration:none;color:inherit}#address,#phone{margin-bottom:1rem}
...
class Ue extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.append(re.content.cloneNode(!0)), this.nameEl = this.shadowRoot.querySelector("h2"), this.adresseEl = this.shadowRoot.querySelector("#address"), this.emailEl = this.shadowRoot.querySelector("#email"), this.phoneEl = this.shadowRoot.querySelector("#phone"), this.orgnrEl = this.shadowRoot.querySelector("#orgnr");
  }
  static get observedAttributes() {
...
class We extends HTMLElement {
  constructor() {
    ...
    const i = this.attachShadow({ mode: "open" });
    i.append(ne.content.cloneNode(!0)), this.burgerEl = i.querySelector("#nav-icon"), this.menuContent = i.querySelector("#menu-content");
  }
  /*
    static get observedAttributes() {
      return [];
...
const Ge = "", ae = document.createElement("template");
ae.innerHTML = `
      <style>
      	${Ge}
...
customElements.get(j) || customElements.define(j, Je);
export {
  je as MilesArrow,
  Se as MilesArrowNav,
  Fe as MilesAuthorCard,
  $e as MilesBlogCard,
  pe as MilesBulb,
  oe as MilesBusinessCard,
  we as MilesButtonAnchor,
  ce as MilesCloud,
  Ue as MilesContactCard,
  ge as MilesCup,
  me as MilesCurve,
  He as MilesFagbloggTeaser,
  Ae as MilesImageSlider,
  Ce as MilesInfo,
  Oe as MilesInfoBlock,
  be as MilesLogo,
  Pe as MilesOfficeBanner,
  Re as MilesOverlapBlock,
  Je as MilesPodcastCard,
  _e as MilesPodcastTeaser,
  fe as MilesPodd,
  xe as MilesProfileCard,
  ue as MilesZoom,
  We as SiteMenu
};
