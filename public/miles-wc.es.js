...
var ae = (s, e, i) => e in s ? ne(s, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : s[e] = i;
var a = (s, e, i) => (ae(s, typeof e != "symbol" ? e + "" : e, i), i);
...
const g = "miles-cloud";
customElements.get(g) || customElements.define(g, le);
...
const u = "miles-heart";
customElements.get(u) || customElements.define(u, de);
...
const f = "miles-curve";
customElements.get(f) || customElements.define(f, ce);
...
const b = "miles-cup";
customElements.get(b) || customElements.define(b, me);
...
const w = "miles-zoom";
customElements.get(w) || customElements.define(w, pe);
...
const x = "miles-pod";
customElements.get(x) || customElements.define(x, ge);
const ue = `:host{display:inline-block;width:inherit;box-sizing:border-box}
...
const k = (s) => [null, "false"].includes(s) === !1, U = document.createElement("template");
U.innerHTML = `
        <style>
          ${r}
...
class ve extends HTMLElement {
  constructor() {
    super();
    const e = this.attachShadow({ mode: "open" });
    e.append(U.content.cloneNode(!0)), this.buttontarget = e.querySelector("#buttonTarget");
  }
  static get observedAttributes() {
...
class we extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }).append(V.content.cloneNode(!0)), this.officeLocation = this.shadowRoot.querySelector("#location"), this.jobTitle = this.shadowRoot.querySelector("#jobtitle"), this.consultantName = this.shadowRoot.querySelector("#name"), this.profileImage = this.shadowRoot.querySelector("#profileimage");
  }
  static get observedAttributes() {
...
class Ce extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }).appendChild(W.content.cloneNode(!0)), this.titlEl = this.shadowRoot.querySelector("#title"), this.dateEl = this.shadowRoot.querySelector("#date");
  }
  static get observedAttributes() {
...
const Ee = `:host{display:inline-block;color:red;--arrow-bg-color: #ffffff;--arrow-color: #b72a26}#arrow-nav{display:flex;padding:.8rem;border-radius:50%;background-color:#94e5db}svg{display:inline-block}
...
class _e extends HTMLElement {
  constructor() {
    super();
    const e = this.attachShadow({ mode: "open" });
    e.appendChild(X.content.cloneNode(!0)), this.nav = e.querySelector("#arrow-nav");
  }
  static get observedAttributes() {
    return ["width", "height", "color"];
  }
...
class Le extends HTMLElement {
  constructor() {
    ...
    i.appendChild(G.content.cloneNode(!0)), this.slides = i.querySelector(".slides"), this.controls = i.querySelector(".controls"), this.wrapper = i.querySelector("#slide-wrapper"), this.numberOfSlides = 0, this.autoPlay = 0, this.index = 0, this.logos = ["equinor", "fjordkraft", "tv2", "cutters", "scaleaq"], this.rightNav = i.querySelector("#rightnav"), this.leftNav = i.querySelector("#leftnav");
  }
  connectedCallback() {
    let i = {
      root: null,
...
class Ae extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.append(J.content.cloneNode(!0));
  }
  connectedCallback() {
...
class He extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.append(K.content.cloneNode(!0)), this.posted = this.shadowRoot.querySelector("#posted"), this.updated = this.shadowRoot.querySelector("#updated"), this.author = this.shadowRoot.querySelector("#author");
  }
  static get observedAttributes() {
...
class $e extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.append(Q.content.cloneNode(!0)), this.list = this.shadowRoot.querySelector("#list");
  }
  connectedCallback() {
    const e = [
      "Systemutvikling",
...
class Ne extends HTMLElement {
  constructor() {
    ...
    this.attachShadow({ mode: "open" }), this.shadowRoot.append(Y.content.cloneNode(!0)), this.banner = this.shadowRoot.querySelector("#banner"), this.menu = this.shadowRoot.querySelector("#menu"), this.people = this.shadowRoot.querySelector("#people"), this.triggerEl = this.shadowRoot.querySelector("#triggerEl"), this.header = null;
  }
  connectedCallback() {
    const i = this.shadowRoot.querySelector("slot").assignedElements()[0];
...
const Re = `:host{display:inline-block;transform:rotate(180deg);transition:transform .5s cubic-bezier(.46,.03,.52,.96)}#arrow{justify-content:center;display:flex;width:inherit;height:inherit;align-items:center}:host(.open){transform:rotate(0)}svg{width:inherit;height:inherit}
...
class Pe extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.append(ee.content.cloneNode(!0));
  }
}
const $ = "miles-arrow";
customElements.get($) || customElements.define($, Pe);
...
class ie extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.append(te.content.cloneNode(!0)), this.emailEl = this.shadowRoot.querySelector("#email"), this.nameEl = this.shadowRoot.querySelector("#name"), this.phoneEl = this.shadowRoot.querySelector("#phone"), this.titleEl = this.shadowRoot.querySelector("#title"), this.firgureEl = this.shadowRoot.querySelector("figure"), this.card = this.shadowRoot.querySelector("#card");
  }
  static get observedAttributes() {
...
customElements.get(z) || customElements.define(z, ie);
class je extends ie {
  constructor() {
    super();
  }
...
class Ze extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.append(oe.content.cloneNode(!0)), this.headingEl = this.shadowRoot.querySelector("h2");
  }
  static get observedAttributes() {
    return ["heading"];
  }
...
const Fe = `:host{display:inline-block;color:inherit}#wrapper{background-color:var(--miles_secondary_four);display:flex;flex-direction:column}h2{margin:0}a{text-decoration:none;color:inherit}#address,#phone{margin-bottom:1rem}
...
class Oe extends HTMLElement {
  constructor() {
    super(), this.attachShadow({ mode: "open" }), this.shadowRoot.append(se.content.cloneNode(!0)), this.nameEl = this.shadowRoot.querySelector("h2"), this.adresseEl = this.shadowRoot.querySelector("#address"), this.emailEl = this.shadowRoot.querySelector("#email"), this.phoneEl = this.shadowRoot.querySelector("#phone"), this.orgnrEl = this.shadowRoot.querySelector("#orgnr");
  }
  static get observedAttributes() {
...
class Ue extends HTMLElement {
  constructor() {
    ...
    const i = this.attachShadow({ mode: "open" });
    i.append(re.content.cloneNode(!0)), this.burgerEl = i.querySelector("#nav-icon"), this.menuContent = i.querySelector("#menu-content");
  }
  /*
    static get observedAttributes() {
      return [];
...
export {
  ...
  He as MilesBlogCard,
  he as MilesBulb,
  ie as MilesBusinessCard,
  ve as MilesButtonAnchor,
  le as MilesCloud,
  Oe as MilesContactCard,
  me as MilesCup,
  ce as MilesCurve,
  Ae as MilesFagbloggTeaser,
  Le as MilesImageSlider,
  ye as MilesInfo,
  Ze as MilesInfoBlock,
  fe as MilesLogo,
  Ne as MilesOfficeBanner,
  $e as MilesOverlapBlock,
  Ce as MilesPodcastTeaser,
  ge as MilesPodd,
  we as MilesProfileCard,
  pe as MilesZoom,
  Ue as SiteMenu
};
