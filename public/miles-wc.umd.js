...
`,d=document.createElement("template");d.innerHTML=`
  ...
  <div class="heart">
    ...
    `;class qe extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild(b.content.cloneNode(!0)),this.svg=t.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(t,i,e){t==="width"&&this.svg.setAttribute("width",e),t==="height"&&this.svg.setAttribute("height",e),t==="color"&&this.svg.setAttribute("fill",e)}}const w="miles-heart";customElements.get(w)||customElements.define(w,qe);const y=document.createElement("template");y.innerHTML=`
    <style>
      ${s}
    ...
    `;class E extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild(C.content.cloneNode(!0)),this.svg=t.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(t,i,e){t==="width"&&this.svg.setAttribute("width",e),t==="height"&&this.svg.setAttribute("height",e),t==="color"&&this.svg.setAttribute("fill",e)}}const M="miles-bulb";customElements.get(M)||customElements.define(M,E);const _=document.createElement("template");_.innerHTML=`
    <style>
      ${s}
    ...
    <div class="cup">
      ...
      `;class S extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild(_.content.cloneNode(!0)),this.svg=t.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(t,i,e){t==="width"&&this.svg.setAttribute("width",e),t==="height"&&this.svg.setAttribute("height",e),t==="color"&&this.svg.setAttribute("fill",e)}}const A="miles-cup";customElements.get(A)||customElements.define(A,S);class L extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.innerHTML=`
        <style>
          ${s}
      ...
      `}}const T="miles-zoom";customElements.get(T)||customElements.define(T,L);class H extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.innerHTML=`
          <style>
            ${s}
        ...
        `}}const q="miles-pod";customElements.get(q)||customElements.define(q,H);const $e=`:host{display:inline-block;width:inherit;box-sizing:border-box}
...
`;class z extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild($.content.cloneNode(!0)),this.svg=t.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(t,i,e){t==="width"&&this.svg.setAttribute("width",e),t==="height"&&this.svg.setAttribute("height",e),t==="color"&&this.svg.setAttribute("fill",e)}}const R="miles-logo";customElements.get(R)||customElements.define(R,z);const N=n=>[null,"false"].includes(n)===!1,P=document.createElement("template");P.innerHTML=`
        <style>
          ${s}
      ...
      `;class B extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.append(P.content.cloneNode(!0)),this.buttontarget=t.querySelector("#buttonTarget")}static get observedAttributes(){return["href","color","selected"]}attributeChangedCallback(t,i,e){t==="href"&&this.buttontarget.setAttribute("href",e),t==="color"&&this.style.setProperty("--color",e),t==="selected"&&(this.buttontarget.setAttribute("aria-selected",N(e)),this.buttontarget.classList.toggle("selected",N(e)))}connectedCallback(){}}const j="miles-button-anchor";customElements.get(j)||customElements.define(j,B);const ze=`:host{display:inline-block;--width: 215px}.profile-card{display:flex;flex-direction:column;width:var(--width);border-radius:5px;overflow:hidden}figure{border-radius:.5rem;height:var(--width);margin:0 0 .5rem;padding:0}img{background-color:#fff;filter:grayscale(1);width:100%;object-fit:cover;aspect-ratio:1 / 1;animation:fadeIn 1s cubic-bezier(.46,.03,.05,.99)}@keyframes fadeIn{0%{opacity:0}to{opacity:1}}.profile-card__info{display:flex;background-color:var(--miles_secondary_four);padding:1.2rem;min-height:140px;flex-direction:column}.jobtitle{flex-grow:1}.jobtitle p{overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;line-clamp:2;-webkit-box-orient:vertical}.description{display:flex;flex-direction:row;align-items:baseline;gap:.2rem}h3,p{margin:0;color:var(--miles_primary_light)}
`,I=document.createElement("template");I.innerHTML=`
      ...
      `;class F extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).append(I.content.cloneNode(!0)),this.officeLocation=this.shadowRoot.querySelector("#location"),this.jobTitle=this.shadowRoot.querySelector("#jobtitle"),this.consultantName=this.shadowRoot.querySelector("#name"),this.profileImage=this.shadowRoot.querySelector("#profileimage")}static get observedAttributes(){return["image","name","jobtitle","location"]}attributeChangedCallback(t,i,e){if(t==="image")if(e===""||e===null){const o="https://www.miles.no/newsite/wp-content/uploads/2019/06/miles_smile.png";this.profileImage.setAttribute("src",o),this.profileImage.setAttribute("alt","Miles Profile Card Image")}else this.profileImage.setAttribute("src",e),this.profileImage.setAttribute("alt","Miles Profile Card Image");t==="location"&&(this.officeLocation.textContent=e),t==="jobtitle"&&(this.jobTitle.textContent=e),t==="name"&&(this.shadowRoot.querySelector("a").setAttribute("href",e.split(" ").join("-").toLowerCase()),this.consultantName.textContent=e)}connectedCallback(){}disconnectedCallback(){}}const Z="miles-profile-card";customElements.get(Z)||customElements.define(Z,F);const Re=`:host{display:inline-block;color:var(--miles_primary_light)}.info{background-color:var(--miles_secondary_four);border-radius:0 99rem 99rem;overflow:hidden;padding:1rem 3rem;display:flex;justify-content:center;align-items:center;flex-direction:row;gap:1.5rem;color:inherit}.info__icon{font-size:1.2rem;font-weight:700}.info__description{font-weight:700;max-width:15rem;font-size:1rem}
...
`,U=document.createElement("template");U.innerHTML=`
      <style>
        ...
        `;class X extends HTMLElement{constructor(){super();l(this,"timeFormat",i=>new Intl.DateTimeFormat("no",{month:"short",day:"numeric"}).format(i));this.attachShadow({mode:"open"}).appendChild(U.content.cloneNode(!0)),this.titlEl=this.shadowRoot.querySelector("#title"),this.dateEl=this.shadowRoot.querySelector("#date")}static get observedAttributes(){return["episode_title","published_date","link"]}attributeChangedCallback(i,e,o){i==="episode_title"&&(this.titlEl.textContent=o),i==="published_date"&&(this.dateEl.textContent=`${this.timeFormat(new Date(o))} - MilesPodden`)}}const W="miles-podcast-teaser";customElements.get(W)||customElements.define(W,X);const Pe=`:host{display:inline-block;color:red;--arrow-bg-color: #ffffff;--arrow-color: #b72a26}#arrow-nav{display:flex;padding:.8rem;border-radius:50%;background-color:#94e5db}svg{display:inline-block}
...
`,ue=document.createElement("template");ue.innerHTML=`
  ...
  <div id="card-wrapper">
    ...
    `;class p extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.append(ue.content.cloneNode(!0)),this.emailEl=this.shadowRoot.querySelector("#email"),this.nameEl=this.shadowRoot.querySelector("#name"),this.phoneEl=this.shadowRoot.querySelector("#phone"),this.titleEl=this.shadowRoot.querySelector("#title"),this.firgureEl=this.shadowRoot.querySelector("figure"),this.card=this.shadowRoot.querySelector("#card")}static get observedAttributes(){return["email","name","phone","jobtitle","image","variant"]}attributeChangedCallback(t,i,e){if(t==="email"&&(this.emailEl.setAttribute("href",`mailto:${e}`),this.phoneEl.style.display="block",this.emailEl.textContent=e),t==="name"&&(this.nameEl.textContent=e),t==="phone"&&(this.phoneEl.setAttribute("href",`tel:${e}`),this.phoneEl.style.display="block",this.phoneEl.textContent=e),t==="jobtitle"&&(this.titleEl.textContent=e),t==="image"){const o=document.createElement("img");o.setAttribute("src",e),this.firgureEl.append(o)}t==="variant"&&(e==="wide"&&(this.card.classList.add("wide"),this.style.setProperty("--image-width","320px")),e==="author"&&(this.card.classList.add("author"),this.style.setProperty("--image-width","180px")))}connectedCallback(){}disconnectedCallback(){}}const fe="miles-business-card";customElements.get(fe)||customElements.define(fe,p);class ve extends p{constructor(){super()}connectedCallback(){super.connectedCallback(),this.setAttribute("variant","author")}attributeChangedCallback(t,i,e){t!=="phone"&&t!=="email"&&super.attributeChangedCallback(t,i,e)}}const be="miles-author-card";customElements.get(be)||customElements.define(be,ve);const Ue=`:host{display:block;color:inherit}@media (min-width: 768px){:host{padding-left:calc(8rem - 2em)}}#wrapper{border:4px solid var(--miles_secondary_four);color:var(--miles_secondary_three);border-radius:1em;padding:2em;position:relative;line-height:2.5em}#heading{max-width:100%;background-color:var(--miles_secondary_four);color:var(--miles_primary_light);border-radius:1em;padding:1em 2em;position:relative;z-index:5;left:-4rem;margin-bottom:4rem}h2{margin:0}@media (min-width: 768px){#heading{max-width:60%;left:-8rem;border-radius:2em}#wrapper{border-radius:2em}h2{margin:revert}}p,p::slotted(*){font-size:1rem;line-height:2.5rem;font-weight:400}
`,we=document.createElement("template");we.innerHTML=`
  ...
  ${s}
    ...
    `;class ye extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.append(we.content.cloneNode(!0)),this.headingEl=this.shadowRoot.querySelector("h2")}static get observedAttributes(){return["heading"]}attributeChangedCallback(t,i,e){t==="heading"&&(this.headingEl.textContent=e)}connectedCallback(){}disconnectedCallback(){}}const xe="miles-info-block";customElements.get(xe)||customElements.define(xe,ye);const Xe=`:host{display:inline-block;color:inherit}#wrapper{background-color:var(--miles_secondary_four);display:flex;flex-direction:column}h2{margin:0}a{text-decoration:none;color:inherit}#address,#phone{margin-bottom:1rem}
...
`,Me=document.createElement("template");Me.innerHTML=`
      ...
      `;class _e extends HTMLElement{constructor(){super();l(this,"openmenu",i=>{console.log("menu toggle"),i.preventDefault(),this.burgerEl.classList.toggle("open-menu"),this.menuContent.classList.toggle("open")});const i=this.attachShadow({mode:"open"});i.append(Me.content.cloneNode(!0)),this.burgerEl=i.querySelector("#nav-icon"),this.menuContent=i.querySelector("#menu-content")}connectedCallback(){this.shadowRoot.querySelector("slot").assignedElements().forEach(i=>{i.tagName==="NAV"&&(i.querySelector('a[href="#"]').remove(),this.menuContent.append(i))}),this.burgerEl.addEventListener("click",this.openmenu)}disconnectedCallback(){this.burgerEl.removeEventListener("click",this.openmenu)}}const Se="miles-site-menu";customElements.get(Se)||customElements.define(Se,_e);const Ge="",Ae=document.createElement("template");Ae.innerHTML=`
      <style>
      	${Ge}
        ...
        `;class Le extends HTMLElement{constructor(){super();l(this,"timeFormat",i=>new Intl.DateTimeFormat("no",{month:"short",day:"numeric"}).format(i));l(this,"createPlayer",i=>{const e=document.createElement("audio");return e.setAttribute("controls",""),e.setAttribute("preload","none"),e.setAttribute("src",i),e});this.attachShadow({mode:"open"}).appendChild(Ae.content.cloneNode(!0)),this.titlEl=this.shadowRoot.querySelector("#title"),this.dateEl=this.shadowRoot.querySelector("#date"),this.summaryEl=this.shadowRoot.querySelector("#summary"),this.descriptionEl=this.shadowRoot.querySelector("#description"),this.playerEl=this.shadowRoot.querySelector("#player")}static get observedAttributes(){return["episode_title","published_date","link","description","url"]}attributeChangedCallback(i,e,o){i==="episode_title"&&(this.titlEl.textContent=o),i==="published_date"&&(this.dateEl.textContent=`${this.timeFormat(new Date(o))} - MilesPodden`),i==="description"&&(this.descriptionEl.textContent=o),i==="url"&&this.playerEl.appendChild(this.createPlayer(o))}}const Te="miles-podcast-card";customElements.get(Te)||customElements.define(Te,Le),r.MilesArrow=pe,r.MilesArrowNav=J,r.MilesAuthorCard=ve,r.MilesBlogCard=se,r.MilesBulb=E,r.MilesBusinessCard=p,r.MilesButtonAnchor=B,r.MilesCloud=f,r.MilesContactCard=Ce,r.MilesCup=S,r.MilesCurve=x,r.MilesFagbloggTeaser=te,r.MilesImageSlider=V,r.MilesInfo=O,r.MilesInfoBlock=ye,r.MilesLogo=z,r.MilesOfficeBanner=ce,r.MilesOverlapBlock=ae,r.MilesPodcastCard=Le,r.MilesPodcastTeaser=X,r.MilesPodd=H,r.MilesProfileCard=F,r.MilesZoom=L,r.SiteMenu=_e,Object.defineProperty(r,Symbol.toStringTag,{value:"Module"})});
