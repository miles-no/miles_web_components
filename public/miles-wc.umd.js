  ...
  <div class="heart">
    ...
    <div class="cup">
      ...
      `}}const T="miles-zoom";customElements.get(T)||customElements.define(T,L);const q=document.createElement("template");q.innerHTML=`
        ...
        `;class H extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(q.content.cloneNode(!0)),this.svgEl=e.querySelector("path")}static get observedAttributes(){return["color"]}attributeChangedCallback(e,i,t){e==="color"&&(t&&t.length>0?this.svgEl.setAttribute("fill",t):this.svgEl.setAttribute("fill","currentColor"))}connectedCallback(){}}const $="miles-pod";customElements.get($)||customElements.define($,H);const Pe=`:host{display:inline-block;width:inherit;box-sizing:border-box}
...
`;class D extends HTMLElement{constructor(){super();a(this,"removeColor",i=>{this.mic.removeAttribute("color"),console.log("remove color")});a(this,"addColor",i=>{this.mic.setAttribute("color","#ff303b"),console.log("add color")});a(this,"goTo",()=>{window.location.href=escape(this.link)});const i=this.attachShadow({mode:"open"});this.link=null,i.innerHTML=`
        <style>
      	${je}
