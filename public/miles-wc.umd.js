...
`,d=document.createElement("template");d.innerHTML=`
  ...
  `;class f extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild(d.content.cloneNode(!0)),this.svg=t.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(t,i,e){t==="width"&&this.svg.setAttribute("width",e),t==="height"&&this.svg.setAttribute("height",e),t==="color"&&this.svg.setAttribute("fill",e)}}const v="miles-cloud";customElements.get(v)||customElements.define(v,f);const b=document.createElement("template");b.innerHTML=` 
  <style>
    ${r}
  ...
  <div class="heart">
    ...
    `;class Ye extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild(b.content.cloneNode(!0)),this.svg=t.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(t,i,e){t==="width"&&this.svg.setAttribute("width",e),t==="height"&&this.svg.setAttribute("height",e),t==="color"&&this.svg.setAttribute("fill",e)}}const w="miles-heart";customElements.get(w)||customElements.define(w,Ye);const y=document.createElement("template");y.innerHTML=`
    <style>
      ${r}
    ...
    <div class="curve">
      ...
      `;class x extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild(y.content.cloneNode(!0)),this.svg=t.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(t,i,e){t==="width"&&this.svg.setAttribute("width",e),t==="height"&&this.svg.setAttribute("height",e),t==="color"&&this.svg.setAttribute("fill",e)}}const C="miles-curve";customElements.get(C)||customElements.define(C,x);const E=document.createElement("template");E.innerHTML=`
    <style>
        ${r}
    ...
    `;class k extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild(E.content.cloneNode(!0)),this.svg=t.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(t,i,e){t==="width"&&this.svg.setAttribute("width",e),t==="height"&&this.svg.setAttribute("height",e),t==="color"&&this.svg.setAttribute("fill",e)}}const M="miles-bulb";customElements.get(M)||customElements.define(M,k);const _=document.createElement("template");_.innerHTML=`
    <style>
      ${r}
    ...
    <div class="cup">
      ...
      `;class L extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild(_.content.cloneNode(!0)),this.svg=t.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(t,i,e){t==="width"&&this.svg.setAttribute("width",e),t==="height"&&this.svg.setAttribute("height",e),t==="color"&&this.svg.setAttribute("fill",e)}}const S="miles-cup";customElements.get(S)||customElements.define(S,L);class A extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.innerHTML=`
        <style>
          ${r}
      ...
      `}}const T="miles-zoom";customElements.get(T)||customElements.define(T,A);const H=document.createElement("template");H.innerHTML=`
          <style>
            ${r}
        ...
        `;class q extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild(H.content.cloneNode(!0)),this.svgEl=t.querySelector("path")}static get observedAttributes(){return["color"]}attributeChangedCallback(t,i,e){t==="color"&&(e&&e.length>0?(this.svgEl.setAttribute("fill",e),this.svgEl.style.transform="scale(1.03)"):(this.svgEl.setAttribute("fill","currentColor"),this.svgEl.style.transform="scale(1)"))}}const P="miles-pod";customElements.get(P)||customElements.define(P,q);const $=document.createElement("template");$.innerHTML=`
      <style> 
        :host {
          display: flex;
          align-items: center;
...
`;class B extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild($.content.cloneNode(!0)),this.svgEl=t.querySelector("path")}static get observedAttributes(){return["color"]}attributeChangedCallback(t,i,e){t==="color"&&(e&&e.length>0?this.svgEl.setAttribute("fill",e):this.svgEl.setAttribute("fill","currentColor"))}}const R="miles-phone";customElements.get(R)||customElements.define(R,B);const N=document.createElement("template");N.innerHTML=`
      <style>
        :host {
          display: flex;
          align-items: center;
...
`;class z extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild(N.content.cloneNode(!0)),this.svgEl=t.querySelector("path")}static get observedAttributes(){return["color"]}attributeChangedCallback(t,i,e){t==="color"&&(e&&e.length>0?this.svgEl.setAttribute("fill",e):this.svgEl.setAttribute("fill","currentColor"))}}const Z="miles-email";customElements.get(Z)||customElements.define(Z,z);const j=document.createElement("template");j.innerHTML=`
      <style></style>
  ...
  `;class I extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).appendChild(j.content.cloneNode(!0))}}const F="miles-play";customElements.get(F)||customElements.define(F,I);const V=document.createElement("template");V.innerHTML=`
      <style></style>
<svg xmlns="http://www.w3.org/2000/svg" height="64" viewBox="0 -960 960 960" width="64">
  ...
  `;class O extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).appendChild(V.content.cloneNode(!0))}}const D="miles-pause";customElements.get(D)||customElements.define(D,O);class Q extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}static get observedAttributes(){return["direction"]}attributeChangedCallback(t,i,e){t==="direction"&&(e==="forward"?this.shadow.innerHTML=`
...
`)}}const U="miles-seek";customElements.get(U)||customElements.define(U,Q);const et=`:host{display:inline-block;width:inherit;box-sizing:border-box}
...
`;class W extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.appendChild(X.content.cloneNode(!0)),this.svg=t.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(t,i,e){t==="width"&&this.svg.setAttribute("width",e),t==="height"&&this.svg.setAttribute("height",e),t==="color"&&this.svg.setAttribute("fill",e)}}const G="miles-logo";customElements.get(G)||customElements.define(G,W);const J=a=>[null,"false"].includes(a)===!1,K=document.createElement("template");K.innerHTML=`
        <style>
          ${r}
      ...
      `;class Y extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});t.append(K.content.cloneNode(!0)),this.buttontarget=t.querySelector("#buttonTarget")}static get observedAttributes(){return["href","color","selected"]}attributeChangedCallback(t,i,e){t==="href"&&this.buttontarget.setAttribute("href",e),t==="color"&&this.style.setProperty("--color",e),t==="selected"&&(this.buttontarget.setAttribute("aria-selected",J(e)),this.buttontarget.classList.toggle("selected",J(e)))}connectedCallback(){}}const ee="miles-button-anchor";customElements.get(ee)||customElements.define(ee,Y);const tt=`:host{display:inline-block;--width: 215px}.profile-card{display:flex;flex-direction:column;width:var(--width);border-radius:5px;overflow:hidden}figure{border-radius:.5rem;height:var(--width);margin:0 0 .5rem;padding:0}img{background-color:#fff;filter:grayscale(1);width:100%;object-fit:cover;aspect-ratio:1 / 1;animation:fadeIn 1s cubic-bezier(.46,.03,.05,.99)}@keyframes fadeIn{0%{opacity:0}to{opacity:1}}.profile-card__info{display:flex;background-color:var(--miles_secondary_four);padding:1.2rem;min-height:140px;flex-direction:column}.jobtitle{flex-grow:1}.jobtitle p{overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;line-clamp:2;-webkit-box-orient:vertical}.description{display:flex;flex-direction:row;align-items:baseline;gap:.2rem}h3,p{margin:0;color:var(--miles_primary_light)}
`,te=document.createElement("template");te.innerHTML=`
      ...
      `;class ie extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).append(te.content.cloneNode(!0)),this.officeLocationEl=this.shadowRoot.querySelector("#location"),this.jobTitleEl=this.shadowRoot.querySelector("#jobtitle"),this.consultantNameEl=this.shadowRoot.querySelector("#name"),this.profileImageEl=this.shadowRoot.querySelector("#profileimage")}static get observedAttributes(){return["image","name","jobtitle","location"]}attributeChangedCallback(t,i,e){if(t==="image")if(e===""||e===null){const o="https://www.miles.no/newsite/wp-content/uploads/2019/06/miles_smile.png";this.profileImageEl.setAttribute("src",o),this.profileImageEl.setAttribute("alt","Miles Profile Card Image")}else this.profileImageEl.setAttribute("src",e),this.profileImageEl.setAttribute("alt","Miles Profile Card Image");t==="location"&&(this.officeLocationEl.textContent=e),t==="jobtitle"&&(this.jobTitleEl.textContent=e),t==="name"&&(this.shadowRoot.querySelector("a").setAttribute("href",e.split(" ").join("-").toLowerCase()),this.consultantNameEl.textContent=e)}connectedCallback(){}disconnectedCallback(){}}const oe="miles-profile-card";customElements.get(oe)||customElements.define(oe,ie);const it=`:host{display:inline-block;color:var(--miles_primary_light)}.info{background-color:var(--miles_secondary_four);border-radius:0 99rem 99rem;overflow:hidden;padding:1rem 3rem;display:flex;justify-content:center;align-items:center;flex-direction:row;gap:1.5rem;color:inherit}.info__icon{font-size:1.2rem;font-weight:700}.info__description{font-weight:700;max-width:15rem;font-size:1rem}.info--link{cursor:pointer}
`;class se extends HTMLElement{constructor(){super();n(this,"removeColor",i=>{this.mic.removeAttribute("color")});n(this,"addColor",i=>{this.mic.setAttribute("color","#ff303b")});n(this,"goTo",()=>{window.location.href=escape(this.link)});const i=this.attachShadow({mode:"open"});this.link=null,i.innerHTML=`
        <style>
      	${it}
      ...
      `}static get observedAttributes(){return["link"]}attributeChangedCallback(i,e,o){i==="link"&&(this.link=o,this.shadowRoot.querySelector(".info").classList.add("info--link"),this.mic=this.shadowRoot.querySelector('slot[name="icon"]').assignedNodes()[0])}connectedCallback(){this.link&&(this.addEventListener("click",this.goTo),this.addEventListener("mouseenter",this.addColor),this.addEventListener("mouseleave",this.removeColor))}disconnectedCallback(){this.removeEventListener("click",this.goTo),this.removeEventListener("mouseenter",this.addColor),this.removeEventListener("mouseleave",this.removeColor)}}const re="miles-info";customElements.get(re)||customElements.define(re,se);const ot=`:host{display:block;color:inherit}.podcast-teaser{box-sizing:border-box;width:100vw;position:relative;height:300px}.bg{background-color:#ff303b1a;width:100%;height:66%;position:absolute;bottom:0}.inner{height:100%;display:flex;flex-direction:column;width:80%;margin:auto;align-items:center;gap:1em;padding-top:2em;max-width:var(--max-page-width)}miles-info{right:10%;left:10%;position:absolute;top:.75em}@media (min-width: 768px){.inner{flex-direction:row;padding-top:0}.podcast-teaser{height:210px}}@media (max-width: 1024px) and (min-width: 769px){miles-info{width:28%;left:unset;top:-1em;right:var(--halve_margin_offset_large)}}@media (min-width: 1025px){miles-info{max-width:250px;left:unset;width:unset;top:1em;right:var(--halve_margin_offset_large)}}.left{display:flex;flex-direction:row;align-items:center;gap:1em}.text{display:flex;flex-direction:column}h3,p{margin:0}p{font-size:.8em;color:var(--miles_primary_dark)}svg{height:70px;width:70px}a.more{color:inherit;right:var(--halve_margin_offset_large);bottom:1em;position:absolute;display:inline-block}a.more:after{content:"→"}
`,ae=document.createElement("template");ae.innerHTML=`
      <style>
        ...
        `;class ne extends HTMLElement{constructor(){super();n(this,"timeFormat",i=>new Intl.DateTimeFormat("no",{month:"short",day:"numeric"}).format(i));this.attachShadow({mode:"open"}).appendChild(ae.content.cloneNode(!0)),this.titlEl=this.shadowRoot.querySelector("#title"),this.dateEl=this.shadowRoot.querySelector("#date")}static get observedAttributes(){return["episode_title","published_date","link"]}attributeChangedCallback(i,e,o){i==="episode_title"&&(this.titlEl.textContent=o),i==="published_date"&&(this.dateEl.textContent=`${this.timeFormat(new Date(o))} - MilesPodden`)}}const le="miles-podcast-teaser";customElements.get(le)||customElements.define(le,ne);const st=`:host{display:inline-block;color:red;--arrow-bg-color: #ffffff;--arrow-color: #b72a26}#arrow-nav{display:flex;padding:.8rem;border-radius:50%;background-color:#94e5db}svg{display:inline-block}
...
`,me=document.createElement("template");me.innerHTML=`
  ...
  <div id="slide-wrapper">
    ...
    `;class pe extends HTMLElement{constructor(){super();n(this,"goRight",()=>{this.startAutoPlay(!1),Math.abs(this.index)!==0&&(this.index++,this.setActiveDot(this.index),this.slides.style.setProperty("--slides-offset",this.index))});n(this,"goLeft",()=>{this.startAutoPlay(!1),Math.abs(this.index)!==this.numberOfSlides-1&&(this.index--,this.setActiveDot(this.index),this.slides.style.setProperty("--slides-offset",this.index))});n(this,"goToSlide",i=>{let e=parseInt(i.target.dataset.slide)*-1;this.numberOfSlides-1===parseInt(i.target.dataset.slide)&&(e=0),this.startAutoPlay(!1),this.slides.style.setProperty("--slides-offset",e),this.setActiveDot(e)});n(this,"startAutoPlay",i=>{i?this.autoPlay=setInterval(()=>{Math.abs(this.index)===this.numberOfSlides-2?this.index=0:this.index--,this.setActiveDot(this.index),this.slides.style.setProperty("--slides-offset",this.index)},5e3):clearInterval(this.autoPlay)});n(this,"setActiveDot",i=>{const e=this.controls.querySelectorAll(".nav-dot");e.forEach(o=>{o.classList.remove("active")}),e.forEach(o=>{parseInt(o.getAttribute("data-slide"))===Math.abs(i)&&o.classList.add("active")})});const i=this.attachShadow({mode:"open"});i.appendChild(me.content.cloneNode(!0)),this.slides=i.querySelector(".slides"),this.controls=i.querySelector(".controls"),this.wrapper=i.querySelector("#slide-wrapper"),this.numberOfSlides=0,this.autoPlay=0,this.index=0,this.logos=["equinor","fjordkraft","tv2","cutters","scaleaq"],this.rightNav=i.querySelector("#rightnav"),this.leftNav=i.querySelector("#leftnav")}connectedCallback(){let i={root:null,rootMargin:"0px",threshold:1};this.observer=new IntersectionObserver(o=>{o.forEach(l=>{l.isIntersecting?this.startAutoPlay(!0):this.startAutoPlay(!1)})},i),this.observer.observe(this.wrapper),this.controls.addEventListener("click",this.goToSlide),this.rightNav.addEventListener("click",this.goLeft),this.leftNav.addEventListener("click",this.goRight);const e=this.shadowRoot.querySelector("slot");if(e){let o=e.assignedElements().length===1?e.assignedElements()[0].children:e.assignedElements();if(typeof o=="object")try{const l=Array.from(o);this.numberOfSlides=o.length,l.forEach((c,Ke)=>{const m=document.createElement("figure"),g=document.createElement("div");if(g.setAttribute("class","overlay"),c.classList.forEach(h=>{this.logos.includes(h)&&g.classList.add(h)}),m.setAttribute("data-slide-image",Ke),m.appendChild(g),c.querySelector("img")){const h=c.querySelector("img");h.setAttribute("draggable",!1),m.appendChild(h),this.slides.appendChild(m);const u=document.createElement("span");u.setAttribute("class","nav-dot"),u.setAttribute("data-slide",Ke),this.controls.appendChild(u)}})}catch{console.log(o)}}this.setActiveDot(this.index)}disconnectedCallback(){this.controls.removeEventListener("click",this.goToSlide),this.observer.unobserve(this.wrapper),this.rightNav.removeEventListener("click",this.goLeft),this.leftNav.removeEventListener("click",this.goRight)}static get observedAttributes(){return["inview","autoplay"]}attributeChangedCallback(i,e,o){}}const ge="miles-image-slider";customElements.get(ge)||customElements.define(ge,pe);const at=`:host{display:block;color:inherit;--maxWidth: 350px;margin-left:10vw;margin-right:10vw}#header{display:flex;max-width:var(--max-page-width);margin:2rem auto;flex-direction:column}#fagblogg-teaser{box-sizing:border-box;width:100%;max-width:var(--max-page-width);position:relative;min-height:800px;margin:auto}.bg{width:100%;height:50%;position:relative;top:5rem}miles-info{position:relative;width:300px}::slotted(ul){grid-template-columns:repeat(1,100%)!important;display:grid!important;gap:2rem!important}@media (min-width: 768px){::slotted(ul){grid-template-columns:repeat(3,calc(33% - 1rem))!important;display:grid!important;gap:2rem!important}#header{flex-direction:row}.podcast-teaser{height:210px}}@media (max-width: 1024px) and (min-width: 769px){miles-info{left:unset;top:1em}.bg{width:100%;height:35%;position:absolute;top:5rem}}@media (min-width: 1025px){miles-info{left:unset;width:unset}}.left{display:flex;flex-direction:row;align-items:center;gap:1em}.text{display:flex;flex-direction:column}h2{margin-bottom:.2rem;line-height:150%;font-size:var(--miles-h2);color:var(--miles_secondary_four);flex-grow:1}@media (min-width: 769px){h2{margin-bottom:1rem}}p{font-size:.8em;color:var(--miles_primary_dark);margin:auto}svg{height:70px;width:70px}a{color:inherit;right:var(--halve_margin_offset_large);bottom:1em;position:absolute;display:inline-block}a:after{content:"→"}
`,ue=document.createElement("template");ue.innerHTML=`
  <style>
  ${r}
${at}
  </style>
...
`;class fe extends HTMLElement{constructor(){super();n(this,"goToPost",i=>{window.location.href=escape(i.target.dataset.post)});this.attachShadow({mode:"open"}),this.shadowRoot.append(ue.content.cloneNode(!0)),this.mic=this.shadowRoot.querySelector("#mic")}connectedCallback(){const i=this.shadowRoot.querySelector("slot").assignedElements()[0];if(i){const e=i.querySelectorAll("img"),o=Array.from(i.querySelectorAll("a"));Array.from(e).forEach((l,c)=>{l.setAttribute("style","height: auto; cursor: pointer;"),l.setAttribute("data-post",o[c].href),l.addEventListener("click",this.goToPost)})}}disconnectedCallback(){}}const ve="miles-fagblogg-teaser";customElements.get(ve)||customElements.define(ve,fe);const nt=`:host{display:block;color:inherit;width:inherit;height:inherit}#blog-card{display:flex;flex-direction:column;gap:.2rem;width:100%;border-radius:1rem;overflow:hidden}slot[name=title]::slotted(*){font-size:1.5rem;margin:0}a{display:block;width:100%;text-decoration:none;color:inherit}.text{background-color:var(--miles_secondary_four);color:var(--miles_primary_light);padding:2rem;height:110px;display:flex;flex-direction:column}slot[name=title]::slotted(*){overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;line-clamp:2;-webkit-box-orient:vertical}slot[name=meta]{display:block;flex-grow:1}#updated{display:none}::slotted(figure){margin:0;aspect-ratio:4/5;overflow:hidden}
...
`;class we extends HTMLElement{constructor(){super();n(this,"timeFormat",i=>new Intl.DateTimeFormat("no",{month:"short",day:"numeric",year:"numeric"}).format(i));this.attachShadow({mode:"open"}),this.shadowRoot.append(be.content.cloneNode(!0)),this.posted=this.shadowRoot.querySelector("#posted"),this.updated=this.shadowRoot.querySelector("#updated"),this.author=this.shadowRoot.querySelector("#author")}static get observedAttributes(){return["url","author","posted","updated"]}attributeChangedCallback(i,e,o){i==="url"&&this.shadowRoot.querySelectorAll("a").forEach(l=>{l.setAttribute("href",o)}),i==="author"&&(this.author.textContent=o)}connectedCallback(){const i=this.shadowRoot.querySelector('slot[name="image"]').assignedElements();i[0]?.children&&Array.from(i[0]?.children).forEach(o=>{o.style.objectFit="cover",o.style.aspectRatio="2/3",o.style.width="100%"});const e=this.shadowRoot.querySelector('slot[name="meta"]').assignedElements();e[0]?.children&&(Array.from(e[0]?.children).forEach(o=>{const l=Array.from(o.children[0].children);this.posted.textContent=`${this.timeFormat(new Date(l[0].dateTime))}`,this.updated.textContent=`${this.timeFormat(new Date(l[1].dateTime))}`}),e[0].remove())}disconnectedCallback(){}}const ye="miles-blog-card";customElements.get(ye)||customElements.define(ye,we);const lt=`:host{--topOffset: 1rem;--bottomOffset: 5rem;--blockRadius: 30px;color:inherit;display:block}#overlap-block{padding:0 2rem;position:relative}#feature-block{border-radius:30px;background-color:#f8ebe8;padding:3rem;width:var(--width);position:relative}@media (min-width: 768px){:host{--topOffset: 16rem}#overlap-block{width:80vw;max-width:var(--max-page-width);margin:auto;position:relative}.parent{display:grid;grid-template-columns:repeat(12,1fr);grid-template-rows:var(--topOffset) auto var(--bottomOffset);grid-column-gap:0px;grid-row-gap:0px}.div1{grid-area:1 / 1 / 2 / 6}.div2{grid-area:1 / 5 / 2 / 13;background-color:var(--miles_secondary_four)}.inner{position:relative;z-index:1;grid-area:2 / 1 / 2 / 13}.inner #content_grid{display:flex;flex-direction:row}#feature-block{border-radius:30px;background-color:#f8ebe8;padding:3rem;width:var(--width);position:relative}::slotted(div){font-size:1.5rem}#feature-block:after{z-index:-1;width:100px;height:100%;content:"";position:absolute;top:0;right:0;background-color:var(--miles_secondary_four)}.div1,.div2{border-top-left-radius:var(--blockRadius);border-top-right-radius:var(--blockRadius);height:var(--topOffset)}.div4{border-bottom-left-radius:var(--blockRadius);border-bottom-right-radius:var(--blockRadius)}.div3{grid-area:1 / 1 / 2 / 6}.div4{grid-area:3 / 5 / 3 / 13;background-color:var(--miles_secondary_four)}#list{width:100%;border-radius:30px;display:flex;flex-direction:column;color:var(--miles_primary_light);background-color:var(--miles_secondary_four);padding:3rem;margin:0;position:relative;z-index:5;min-width:fit-content;left:-10vw;bottom:10vw}}#list{border-radius:unset;left:unset;bottom:unset;display:flex;flex-direction:column;color:var(--miles_primary_light);background-color:var(--miles_secondary_four);padding:3rem;margin:0;position:relative;z-index:5;min-width:fit-content}#list ul{position:relative;top:calc(-1 * var(--topOffset));padding:0}#list li{line-height:38px;list-style:none;padding:.5rem 0;font-size:1.5rem}miles-bulb{position:absolute;right:6rem;bottom:5rem;z-index:20}miles-curve{margin-right:.5em}
...
`;class Me extends HTMLElement{constructor(){super();n(this,"toggleMenu",()=>{const i=this.menu.querySelectorAll("miles-business-card"),e=this.banner.getBoundingClientRect();this.menu.classList.toggle("open"),this.banner.classList.toggle("open"),this.menu.classList.contains("open")?(this.triggerEl.querySelector("miles-arrow").classList.remove("open"),e.width<769&&this.banner.setAttribute("style",`height: calc(calc(${i.length} * var(--headerHeight)) + 300px);`)):(this.banner.removeAttribute("style"),this.triggerEl.querySelector("miles-arrow").classList.add("open"),this.banner.classList.toggle("open"))});this.attachShadow({mode:"open"}),this.shadowRoot.append(ke.content.cloneNode(!0)),this.banner=this.shadowRoot.querySelector("#banner"),this.menu=this.shadowRoot.querySelector("#menu"),this.people=this.shadowRoot.querySelector("#people"),this.triggerEl=this.shadowRoot.querySelector("#triggerEl"),this.triggerBg=this.shadowRoot.querySelector("#triggerBg"),this.header=null}connectedCallback(){const i=this.shadowRoot.querySelector("slot").assignedElements()[0];this.menu.append(i.querySelector(".miles-office-menu")),this.trigger=i.querySelector("h2"),this.setAttribute("id",this.trigger.textContent.replace(/\s/g,"").toLowerCase()),this.trigger.innerHTML=`<span>${this.trigger.textContent}</span><miles-arrow class="open" style="margin-left:1rem;"></miles-arrow>`,this.triggerEl.append(this.trigger),this.banner.append(i.querySelector(".feature-image"));const e=this.menu.querySelectorAll("miles-business-card");e&&e.forEach(l=>{this.people.append(l)});const o=this.banner.getBoundingClientRect();this.trigger&&o.width>769?(this.trigger.setAttribute("style","cursor: pointer; "),this.triggerBg.addEventListener("click",this.toggleMenu)):(this.triggerEl.querySelector("miles-arrow").classList.add("open"),this.menu.classList.add("open"),this.banner.classList.add("open"))}disconnectedCallback(){this.triggerBg.removeEventListener("click",this.toggleMenu)}}const _e="miles-office-banner";customElements.get(_e)||customElements.define(_e,Me);const ct=`:host{display:inline-block;transform:rotate(180deg);transition:transform .5s cubic-bezier(.46,.03,.52,.96)}#arrow{justify-content:center;display:flex;width:inherit;height:inherit;align-items:center}:host(.open){transform:rotate(0)}svg{width:inherit;height:inherit}
...
`,Te=document.createElement("template");Te.innerHTML=`
  ...
  <div id="card-wrapper">
    ...
    `;class p extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.append(Te.content.cloneNode(!0)),this.emailEl=this.shadowRoot.querySelector("#email_el"),this.nameEl=this.shadowRoot.querySelector("#name"),this.phoneEl=this.shadowRoot.querySelector("#phone_el"),this.phoneAnchor=this.shadowRoot.querySelector("#phone"),this.mailAnchor=this.shadowRoot.querySelector("#email"),this.titleEl=this.shadowRoot.querySelector("#title"),this.firgureEl=this.shadowRoot.querySelector("figure"),this.card=this.shadowRoot.querySelector("#card")}static get observedAttributes(){return["email","name","phone","jobtitle","image","variant"]}attributeChangedCallback(t,i,e){if(t==="email"&&(this.mailAnchor.setAttribute("href",`mailto:${e}`),this.mailAnchor.textContent=e),t==="name"&&(this.nameEl.textContent=e),t==="phone"&&(this.phoneAnchor.setAttribute("href",`tel:${e}`),this.shadowRoot.querySelector("#phone").style.display="block",this.phoneAnchor.textContent=e),t==="jobtitle"&&(this.titleEl.textContent=e),t==="image"){const o=document.createElement("img");o.setAttribute("src",e),this.firgureEl.append(o)}t==="variant"&&(e==="wide"&&(this.card.classList.add("wide"),this.style.setProperty("--image-width","320px")),e==="author"&&(this.card.classList.add("author"),this.style.setProperty("--image-width","180px")))}}const He="miles-business-card";customElements.get(He)||customElements.define(He,p);class qe extends p{constructor(){super()}connectedCallback(){super.connectedCallback(),this.setAttribute("variant","author")}attributeChangedCallback(t,i,e){t!=="phone"&&t!=="email"&&super.attributeChangedCallback(t,i,e)}}const Pe="miles-author-card";customElements.get(Pe)||customElements.define(Pe,qe);const mt=`:host{display:block;color:inherit}@media (min-width: 768px){:host{padding-left:calc(8rem - 2em)}}#wrapper{border:4px solid var(--miles_secondary_four);color:var(--miles_secondary_three);border-radius:1em;padding:2em;position:relative;line-height:2.5em}#heading{max-width:100%;background-color:var(--miles_secondary_four);color:var(--miles_primary_light);border-radius:1em;padding:1em 2em;position:relative;z-index:5;left:-4rem;margin-bottom:4rem}h2{margin:0}@media (min-width: 768px){#heading{max-width:60%;left:-8rem;border-radius:2em}#wrapper{border-radius:2em}h2{margin:revert}}p,p::slotted(*){font-size:1rem;line-height:2.5rem;font-weight:400}
`,$e=document.createElement("template");$e.innerHTML=`
  ...
  ${r}
    ...
    `;class Be extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.append($e.content.cloneNode(!0)),this.headingEl=this.shadowRoot.querySelector("h2")}static get observedAttributes(){return["heading"]}attributeChangedCallback(t,i,e){t==="heading"&&(this.headingEl.textContent=e)}connectedCallback(){}disconnectedCallback(){}}const Re="miles-info-block";customElements.get(Re)||customElements.define(Re,Be);const pt=`:host{display:inline-block;color:inherit}#wrapper{background-color:var(--miles_secondary_four);display:flex;flex-direction:column}h2{margin:0}a{text-decoration:none;color:inherit}#address,#phone{margin-bottom:1rem}
...
`,je=document.createElement("template");je.innerHTML=`
      ...
      `;class Ie extends HTMLElement{constructor(){super();n(this,"openmenu",i=>{console.log("menu toggle"),i.preventDefault(),this.burgerEl.classList.toggle("open-menu"),this.menuContent.classList.toggle("open")});const i=this.attachShadow({mode:"open"});i.append(je.content.cloneNode(!0)),this.burgerEl=i.querySelector("#nav-icon"),this.menuContent=i.querySelector("#menu-content")}connectedCallback(){this.shadowRoot.querySelector("slot").assignedElements().forEach(i=>{i.tagName==="NAV"&&(i.querySelector('a[href="#"]').remove(),this.menuContent.append(i))}),this.burgerEl.addEventListener("click",this.openmenu)}disconnectedCallback(){this.burgerEl.removeEventListener("click",this.openmenu)}}const Fe="miles-site-menu";customElements.get(Fe)||customElements.define(Fe,Ie);const ut="",Ve=document.createElement("template");Ve.innerHTML=`
      <style>
      	${ut}
...
`;class Ge extends HTMLElement{constructor(){super();n(this,"forwardSeek",i=>{this.audioPlayerEl.currentTime=this.audioPlayerEl.currentTime+i});n(this,"backwardSeek",i=>{this.audioPlayerEl.currentTime=this.audioPlayerEl.currentTime-i});n(this,"durationChnagehandler",i=>{console.log(i.target.duration)});n(this,"timeUpdateHandler",()=>{this.progresstimeEl.textContent=`${this.getTimeString(this.audioPlayerEl.currentTime)} / ${this.getTimeString(this.audioPlayerEl.duration)}`,this.progressbarEl.setAttribute("value",this.audioPlayerEl.currentTime),this.updateProgress()});n(this,"progressChangeHandler",()=>{this.audioPlayerEl.currentTime=this.progressbarEl.value,this.updateProgress()});n(this,"loadMetadataHandler",()=>{this.progressbarEl.max=this.audioPlayerEl.duration,this.progresstimeEl.textContent=`0:00 / ${this.getTimeString(this.audioPlayerEl.duration)}`,this.updateProgress()});n(this,"updateProgress",()=>{console.log("progress");let i=this.progressbarEl;const e=0,o=i.max||100,l=this.audioPlayerEl.currentTime;i.style.backgroundSize=(l-e)*100/(o-e)+"% 100%"});n(this,"play",()=>{this.audioContext.state==="suspended"&&this.audioContext.resume(),this.playButtonEl.dataset.playing==="false"?(this.audioPlayerEl.play(),this.playButtonEl.dataset.playing="true",this.playButtonEl.innerHTML="<miles-pause></miles-pause>"):this.playButtonEl.dataset.playing==="true"&&(this.audioPlayerEl.pause(),this.playButtonEl.dataset.playing="false",this.playButtonEl.innerHTML="<miles-play></miles-play>")});this.attachShadow({mode:"open"}),this.shadowRoot.append(We.content.cloneNode(!0)),this.audioEl=this.shadowRoot.querySelector("#milesplayer"),this.audioPlayerEl=this.shadowRoot.querySelector("#player"),this.playButtonEl=this.shadowRoot.querySelector("#play"),this.progresstimeEl=this.shadowRoot.querySelector("#progresstime"),this.progressbarEl=this.shadowRoot.querySelector("#progressbar"),this.backwardSeekEl=this.shadowRoot.querySelector("#backward"),this.forwardSeekEl=this.shadowRoot.querySelector("#forward"),this.audioContext}static get observedAttributes(){return["src"]}attributeChangedCallback(i,e,o){i==="src"&&(this.audioPlayerEl.src=o)}connectedCallback(){const i=window.AudioContext||window.webkitAudioContext;this.audioContext=new i,this.audioContext.createMediaElementSource(this.audioPlayerEl).connect(this.audioContext.destination),this.playButtonEl.addEventListener("click",this.play),this.audioPlayerEl.addEventListener("durationchange",this.durationChnagehandler),this.audioPlayerEl.addEventListener("progress",this.durationChnagehandler),this.audioPlayerEl.addEventListener("timeupdate",this.timeUpdateHandler),this.audioPlayerEl.addEventListener("loadedmetadata",this.loadMetadataHandler),this.progressbarEl.addEventListener("change",this.progressChangeHandler),this.forwardSeekEl.addEventListener("click",()=>this.forwardSeek(15)),this.backwardSeekEl.addEventListener("click",()=>this.backwardSeek(15))}disconnectedCallback(){this.playButtonEl.removeEventListener("click",this.play),this.audioPlayerEl.removeEventListener("durationchange",this.durationChnagehandler),this.audioPlayerEl.removeEventListener("progress",this.durationChnagehandler),this.audioPlayerEl.removeEventListener("loadedmetadata",this.loadMetadataHandler),this.progressbarEl.removeEventListener("change",this.progressChangeHandler)}getTimeString(i){const e=`${parseInt(`${i%60}`,10)}`.padStart(2,"0");return`${parseInt(`${i/60%60}`,10)}:${e}`}}const Je="miles-audio-player";customElements.get(Je)||customElements.define(Je,Ge),s.MilesArrow=Se,s.MilesArrowNav=ce,s.MilesAudioPlayer=Ge,s.MilesAudioSeek=Q,s.MilesAuthorCard=qe,s.MilesBanner=Ue,s.MilesBlogCard=we,s.MilesBulb=k,s.MilesBusinessCard=p,s.MilesButtonAnchor=Y,s.MilesCloud=f,s.MilesContactCard=ze,s.MilesCup=L,s.MilesCurve=x,s.MilesEmail=z,s.MilesFagbloggTeaser=fe,s.MilesImageSlider=pe,s.MilesInfo=se,s.MilesInfoBlock=Be,s.MilesLogo=W,s.MilesOfficeBanner=Me,s.MilesOverlapBlock=Ce,s.MilesPause=O,s.MilesPhone=B,s.MilesPlay=I,s.MilesPodcastCard=Oe,s.MilesPodcastTeaser=ne,s.MilesPodd=q,s.MilesProfileCard=ie,s.MilesZoom=A,s.SiteMenu=Ie,Object.defineProperty(s,Symbol.toStringTag,{value:"Module"})});
