...
`,d=document.createElement("template");d.innerHTML=`
  ...
  <div class="heart">
    ...
    `;class Ye extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(b.content.cloneNode(!0)),this.svg=e.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(e,i,t){e==="width"&&this.svg.setAttribute("width",t),e==="height"&&this.svg.setAttribute("height",t),e==="color"&&this.svg.setAttribute("fill",t)}}const w="miles-heart";customElements.get(w)||customElements.define(w,Ye);const y=document.createElement("template");y.innerHTML=`
    <style>
      ${r}
    ...
    <div class="curve">
      ...
      `;class C extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(y.content.cloneNode(!0)),this.svg=e.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(e,i,t){e==="width"&&this.svg.setAttribute("width",t),e==="height"&&this.svg.setAttribute("height",t),e==="color"&&this.svg.setAttribute("fill",t)}}const x="miles-curve";customElements.get(x)||customElements.define(x,C);const E=document.createElement("template");E.innerHTML=`
    <style>
        ${r}
    ...
    `;class k extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(E.content.cloneNode(!0)),this.svg=e.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(e,i,t){e==="width"&&this.svg.setAttribute("width",t),e==="height"&&this.svg.setAttribute("height",t),e==="color"&&this.svg.setAttribute("fill",t)}}const M="miles-bulb";customElements.get(M)||customElements.define(M,k);const _=document.createElement("template");_.innerHTML=`
    <style>
      ${r}
    ...
    <div class="cup">
      ...
      `;class L extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(_.content.cloneNode(!0)),this.svg=e.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(e,i,t){e==="width"&&this.svg.setAttribute("width",t),e==="height"&&this.svg.setAttribute("height",t),e==="color"&&this.svg.setAttribute("fill",t)}}const H="miles-cup";customElements.get(H)||customElements.define(H,L);class S extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.innerHTML=`
        <style>
          ${r}
      ...
      `}}const A="miles-zoom";customElements.get(A)||customElements.define(A,S);const T=document.createElement("template");T.innerHTML=`
          <style>
            ${r}
        ...
        `;class q extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(T.content.cloneNode(!0)),this.svgEl=e.querySelector("path")}static get observedAttributes(){return["color"]}attributeChangedCallback(e,i,t){e==="color"&&(t&&t.length>0?(this.svgEl.setAttribute("fill",t),this.svgEl.style.transform="scale(1.03)"):(this.svgEl.setAttribute("fill","currentColor"),this.svgEl.style.transform="scale(1)"))}}const P="miles-pod";customElements.get(P)||customElements.define(P,q);const $=document.createElement("template");$.innerHTML=`
      <style> 
        :host {
          display: flex;
          align-items: center;
...
`;class B extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild($.content.cloneNode(!0)),this.svgEl=e.querySelector("path")}static get observedAttributes(){return["color"]}attributeChangedCallback(e,i,t){e==="color"&&(t&&t.length>0?this.svgEl.setAttribute("fill",t):this.svgEl.setAttribute("fill","currentColor"))}}const z="miles-phone";customElements.get(z)||customElements.define(z,B);const N=document.createElement("template");N.innerHTML=`
      <style>
        :host {
          display: flex;
          align-items: center;
...
`;class R extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(N.content.cloneNode(!0)),this.svgEl=e.querySelector("path")}static get observedAttributes(){return["color"]}attributeChangedCallback(e,i,t){e==="color"&&(t&&t.length>0?this.svgEl.setAttribute("fill",t):this.svgEl.setAttribute("fill","currentColor"))}}const Z="miles-email";customElements.get(Z)||customElements.define(Z,R);const V=document.createElement("template");V.innerHTML=`
      <style></style>
  ...
  `;class j extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).appendChild(V.content.cloneNode(!0))}}const I="miles-play";customElements.get(I)||customElements.define(I,j);const F=document.createElement("template");F.innerHTML=`
      <style></style>
<svg xmlns="http://www.w3.org/2000/svg" height="64" viewBox="0 -960 960 960" width="64">
  ...
  `;class O extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).appendChild(F.content.cloneNode(!0))}}const D="miles-pause";customElements.get(D)||customElements.define(D,O);class Q extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}static get observedAttributes(){return["direction"]}attributeChangedCallback(e,i,t){e==="direction"&&(t==="forward"?this.shadow.innerHTML=`
...
`;class X extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(W.content.cloneNode(!0)),this.svg=e.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(e,i,t){e==="width"&&this.svg.setAttribute("width",t),e==="height"&&this.svg.setAttribute("height",t),e==="color"&&this.svg.setAttribute("fill",t)}}const G="miles-logo";customElements.get(G)||customElements.define(G,X);const J=a=>[null,"false"].includes(a)===!1,K=document.createElement("template");K.innerHTML=`
        <style>
          ${r}
...
`,Ae=document.createElement("template");Ae.innerHTML=`
  ...
  <div id="card-wrapper">
    ...
    `;class p extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.append(Ae.content.cloneNode(!0)),this.emailEl=this.shadowRoot.querySelector("#email_el"),this.nameEl=this.shadowRoot.querySelector("#name"),this.phoneEl=this.shadowRoot.querySelector("#phone_el"),this.phoneAnchor=this.shadowRoot.querySelector("#phone"),this.mailAnchor=this.shadowRoot.querySelector("#email"),this.titleEl=this.shadowRoot.querySelector("#title"),this.firgureEl=this.shadowRoot.querySelector("figure"),this.card=this.shadowRoot.querySelector("#card")}static get observedAttributes(){return["email","name","phone","jobtitle","image","variant"]}attributeChangedCallback(e,i,t){if(e==="email"&&(this.mailAnchor.setAttribute("href",`mailto:${t}`),this.mailAnchor.textContent=t),e==="name"&&(this.nameEl.textContent=t),e==="phone"&&(this.phoneAnchor.setAttribute("href",`tel:${t}`),this.shadowRoot.querySelector("#phone").style.display="block",this.phoneAnchor.textContent=t),e==="jobtitle"&&(this.titleEl.textContent=t),e==="image"){const o=document.createElement("img");o.setAttribute("src",t),this.firgureEl.append(o)}e==="variant"&&(t==="wide"&&(this.card.classList.add("wide"),this.style.setProperty("--image-width","320px")),t==="author"&&(this.card.classList.add("author"),this.style.setProperty("--image-width","180px")))}}const Te="miles-business-card";customElements.get(Te)||customElements.define(Te,p);class qe extends p{constructor(){super()}connectedCallback(){super.connectedCallback(),this.setAttribute("variant","author")}attributeChangedCallback(e,i,t){e!=="phone"&&e!=="email"&&super.attributeChangedCallback(e,i,t)}}const Pe="miles-author-card";customElements.get(Pe)||customElements.define(Pe,qe);const mt=`:host{display:block;color:inherit}@media (min-width: 768px){:host{padding-left:calc(8rem - 2em)}}#wrapper{border:4px solid var(--miles_secondary_four);color:var(--miles_secondary_three);border-radius:1em;padding:2em;position:relative;line-height:2.5em}#heading{max-width:100%;background-color:var(--miles_secondary_four);color:var(--miles_primary_light);border-radius:1em;padding:1em 2em;position:relative;z-index:5;left:-4rem;margin-bottom:4rem}h2{margin:0}@media (min-width: 768px){#heading{max-width:60%;left:-8rem;border-radius:2em}#wrapper{border-radius:2em}h2{margin:revert}}p,p::slotted(*){font-size:1rem;line-height:2.5rem;font-weight:400}
...
`;class Ge extends HTMLElement{constructor(){super();n(this,"forwardSeek",i=>{this.audioPlayerEl.currentTime=this.audioPlayerEl.currentTime+i});n(this,"backwardSeek",i=>{this.audioPlayerEl.currentTime=this.audioPlayerEl.currentTime-i});n(this,"timeUpdateHandler",()=>{this.progresstimeEl.textContent=`${this.getTimeString(this.audioPlayerEl.currentTime)} / ${this.getTimeString(this.audioPlayerEl.duration)}`,this.progressbarEl.setAttribute("value",this.audioPlayerEl.currentTime),this.updateProgress()});n(this,"progressChangeHandler",()=>{this.audioPlayerEl.currentTime=this.progressbarEl.value,this.updateProgress()});n(this,"loadMetadataHandler",()=>{this.progressbarEl.max=this.audioPlayerEl.duration,this.progresstimeEl.textContent=`0:00 / ${this.getTimeString(this.audioPlayerEl.duration)}`,this.updateProgress()});n(this,"updateProgress",()=>{console.log("progress");let i=this.progressbarEl;const t=0,o=i.max||100,l=this.audioPlayerEl.currentTime;i.style.backgroundSize=(l-t)*100/(o-t)+"% 100%"});n(this,"play",()=>{this.audioContext.state==="suspended"&&this.audioContext.resume(),this.playButtonEl.dataset.playing==="false"?(this.audioPlayerEl.play(),this.playButtonEl.dataset.playing="true",this.playButtonEl.innerHTML="<miles-pause></miles-pause>",this.playButtonEl.setAttribute("aria-label","pause")):this.playButtonEl.dataset.playing==="true"&&(this.audioPlayerEl.pause(),this.playButtonEl.dataset.playing="false",this.playButtonEl.innerHTML="<miles-play></miles-play>",this.playButtonEl.setAttribute("aria-label","play"))});this.attachShadow({mode:"open"}),this.shadowRoot.append(Xe.content.cloneNode(!0)),this.audioEl=this.shadowRoot.querySelector("#milesplayer"),this.audioPlayerEl=this.shadowRoot.querySelector("#player"),this.playButtonEl=this.shadowRoot.querySelector("#play"),this.progresstimeEl=this.shadowRoot.querySelector("#progresstime"),this.progressbarEl=this.shadowRoot.querySelector("#progressbar"),this.backwardSeekEl=this.shadowRoot.querySelector("#backward"),this.forwardSeekEl=this.shadowRoot.querySelector("#forward"),this.audioContext}static get observedAttributes(){return["src"]}attributeChangedCallback(i,t,o){i==="src"&&(this.audioPlayerEl.src=o)}connectedCallback(){const i=window.AudioContext||window.webkitAudioContext;this.audioContext=new i,this.audioContext.createMediaElementSource(this.audioPlayerEl).connect(this.audioContext.destination),this.playButtonEl.addEventListener("click",this.play),this.audioPlayerEl.addEventListener("timeupdate",this.timeUpdateHandler),this.audioPlayerEl.addEventListener("loadedmetadata",this.loadMetadataHandler),this.progressbarEl.addEventListener("change",this.progressChangeHandler),this.forwardSeekEl.addEventListener("click",()=>this.forwardSeek(15)),this.backwardSeekEl.addEventListener("click",()=>this.backwardSeek(15))}disconnectedCallback(){this.playButtonEl.removeEventListener("click",this.play),this.audioPlayerEl.removeEventListener("loadedmetadata",this.loadMetadataHandler),this.progressbarEl.removeEventListener("change",this.progressChangeHandler)}getTimeString(i){if(isNaN(i))return"00:00";const t=`${parseInt(`${i%60}`,10)}`.padStart(2,"0");return`${parseInt(`${i/60%60}`,10)}:${t}`}}const Je="miles-audio-player";customElements.get(Je)||customElements.define(Je,Ge),s.MilesArrow=He,s.MilesArrowNav=ce,s.MilesAudioPlayer=Ge,s.MilesAudioSeek=Q,s.MilesAuthorCard=qe,s.MilesBanner=Ue,s.MilesBlogCard=we,s.MilesBulb=k,s.MilesBusinessCard=p,s.MilesButtonAnchor=Y,s.MilesCloud=f,s.MilesContactCard=Re,s.MilesCup=L,s.MilesCurve=C,s.MilesEmail=R,s.MilesFagbloggTeaser=fe,s.MilesImageSlider=pe,s.MilesInfo=se,s.MilesInfoBlock=Be,s.MilesLogo=X,s.MilesOfficeBanner=Me,s.MilesOverlapBlock=xe,s.MilesPause=O,s.MilesPhone=B,s.MilesPlay=j,s.MilesPodcastCard=Oe,s.MilesPodcastTeaser=ne,s.MilesPodd=q,s.MilesProfileCard=ie,s.MilesZoom=S,s.SiteMenu=je,Object.defineProperty(s,Symbol.toStringTag,{value:"Module"})});
