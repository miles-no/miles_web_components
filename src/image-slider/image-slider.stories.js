...
<div style="overflow: hidden; width: 100%; height: 100%; position: relative;">
  <miles-image-slider ${propsToAttrs(args)}>
    ...
    <figure data-slide-image="3" class="ruter">
      <img decoding="async" loading="lazy" width="796" height="550"
        src="${BASE_URL}wp-content/uploads/2023/06/carousell_image-796x550.png" alt="" class="wp-image-9996" srcset="
                  ...
                  " sizes="(max-width: 796px) 100vw, 796px" draggable="false" />
    </figure>
    <figure data-slide-image="4" class="telenor">
      <img decoding="async" loading="lazy" width="978" height="550"
        src="${BASE_URL}wp-content/uploads/2023/06/carousell_image02-978x550.jpeg" alt="" class="wp-image-9995" srcset="
                  ...
                  " sizes="(max-width: 978px) 100vw, 978px" draggable="false" />
    </figure>
  </miles-image-slider>
</div>
`,
