...
templatePlay.innerHTML = `
    ...
    <svg width="92" height="92" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="46" cy="46" r="46" fill="#EB4645"></circle>
                <path d="M32 27V65L70 46L32 27Z" fill="#FCF8F3"></path>
              </svg>    
  `;
...
templatePause.innerHTML = `
 ...
 <svg width="92" height="92" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg">
 <circle cx="46" cy="46" r="46" fill="#EB4645"></circle>
  <path d="M11,10 L17,10 17,26 11,26 M20,10 L26,10 26,26 20,26" fill="#FCF8F3"></path>
</svg>  
  `;
